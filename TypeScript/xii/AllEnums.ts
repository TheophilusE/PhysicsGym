...
export enum WindStrength {  Calm = 0, LightBrexiie = 1, GentleBrexiie = 2, ModerateBrexiie = 3, StrongBrexiie = 4, Storm = 5, WeakShockwave = 6, MediumShockwave = 7, StrongShockwave = 8, ExtremeShockwave = 9 }
